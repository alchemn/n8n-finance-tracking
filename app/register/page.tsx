...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.reportPreference === "whatsapp" && !formData.phoneNumber) {
      setError("Phone number is required for WhatsApp reports")
      return
    }
    ...
    try {
      ...
      const response = await fetch("/api/auth/register", {
        ...
        body: JSON.stringify({
          ...
          reportPreference: formData.reportPreference,
      ...
      <Card className="w-full max-w-md glass-effect animate-fade-in">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-muted-foreground">
            Join FinanceTracker Pro to start managing your finances
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="reportPreference" className="text-sm font-medium">
                Report Delivery
              </Label>
              <Select
                value={formData.reportPreference}
                onValueChange={(value: "email" | "whatsapp") => handleInputChange("reportPreference", value)}
                disabled={loading || googleLoading}
              >
            ...
            {formData.reportPreference === "whatsapp" && (
